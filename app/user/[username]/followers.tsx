...
import { getUserByUsername, getUserFollowers, followUser, unfollowUser } from '@/services/users';
...
export default function FollowersScreen() {
  ...
  const followMutation = useMutation({
    ...
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: queryKeys.userFollowers(profileUser?.id ?? '') });
...
function UserRow({
  user, currentUserId, isOwnProfile, onFollowToggle,
}: {
  user: User;
